...
@section('content')
    <form action="{{ route('registration.update', ['pendaftaran' => $registration]) }}" method="POST"
        enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card card-body">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title fw-semibold mb-0">Edit Pendaftaran</h5>
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror"
                                    id="name" name="nama_lengkap"
                                    value="{{ old('nama_lengkap', $registration->siswa->nama_lengkap) }}" />
                                @error('nama_lengkap')
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control @error('nama_panggilan') is-invalid @enderror"
                                    ...
                                    value="{{ old('nama_panggilan', $registration->siswa->nama_panggilan) }}" />
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-8">
                                <select type="text" class="form-select @error('jenis_kelamin') is-invalid @enderror"
                                    ...
                                    <option @selected(old('jenis_kelamin', $registration->siswa->jenis_kelamin) == 'Laki-Laki')>Laki-Laki</option>
                                    <option @selected(old('jenis_kelamin', $registration->siswa->jenis_kelamin) == 'Perempuan')>Perempuan</option>
                                </select>
                                @error('jenis_kelamin')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-5 mb-3 mb-sm-0">
                                <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror"
                                    ...
                                    value="{{ old('tempat_lahir', $registration->siswa->tempat_lahir) }}" />
                                @error('tempat_lahir')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-sm-3">
                                <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror"
                                    ...
                                    value="{{ old('tanggal_lahir', $registration->siswa->tanggal_lahir->toDateString()) }}" />
                                @error('tanggal_lahir')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control @error('nama_orang_tua') is-invalid @enderror"
                                    ...
                                    value="{{ old('nama_orang_tua', $registration->siswa->nama_orang_tua) }}" />
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control @error('kelas') is-invalid @enderror"
                                    id="kelas" name="kelas"
                                    value="{{ old('kelas', $registration->siswa->kelas) }}" />
                                @error('kelas')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control @error('sekolah') is-invalid @enderror"
                                    ...
                                    value="{{ old('sekolah', $registration->siswa->sekolah) }}" />
                                @error('sekolah')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-8">
                                <input type="tel" class="form-control @error('no_wa') is-invalid @enderror"
                                    id="no_wa" name="no_wa"
                                    value="{{ old('no_wa', $registration->siswa->no_wa) }}" />
                                @error('no_wa')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    id="email" name="email"
                                    value="{{ old('email', $registration->siswa->email) }}" />
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-8">
                                <textarea type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat"
                                    rows="3">{{ old('alamat', $registration->siswa->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('info') is-invalid @enderror" id="info"
                                name="info">
                                <option @selected(old('info', $registration->info) == 'Teman')>Teman</option>
                                <option @selected(old('info', $registration->info) == 'Media Sosial')>Media Sosial</option>
                                <option @selected(old('info', $registration->info) == 'Brosur')>Brosur</option>
                                <option @selected(old('info', $registration->info) == 'Lainnya')>Lainnya</option>
                            </select>
                            @error('info')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('metode_pembayaran') is-invalid @enderror"
                                ...
                                <option @selected(old('metode_pembayaran', $registration->metode_pembayaran) == 'E-Wallet')>E-Wallet</option>
                                <option @selected(old('metode_pembayaran', $registration->metode_pembayaran) == 'Transfer Bank')>Transfer Bank</option>
                            </select>
                        ...
                        <div>
                            ...
                            <small class="text-muted">
                                *File akan hilang jika terjadi kesalahan, silakan upload ulang
                            </small>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('hari') is-invalid @enderror" id="hari"
                                name="hari">
                                <option @selected(old('hari', $selectedHari) == 'Senin Rabu Jumat')>Senin Rabu Jumat</option>
                                <option @selected(old('hari', $selectedHari) == 'Selasa Kamis Sabtu')>Selasa Kamis Sabtu</option>
                            </select>
                            @error('hari')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        @foreach ($hours as $hour)
                            <div class="form-check py-2">
                                <input class="form-check-input" type="checkbox" name="jam[]"
                                    ...
                                    {{ in_array($hour->jam, old('jam', $selectedJam)) ? 'checked' : '' }}>
