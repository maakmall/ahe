    ...
    <form action="{{ route('leave.update', $leave->id) }}" method="POST">
        ...
        <div class="card card-body">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0 fw-semibold">Edit Cuti</h5>
        ...
        <div class="card mb-0">
            <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <select class="form-select @error('id_siswa') is-invalid @enderror"
                            ...
                            @foreach ($students as $student)
                                <option value="{{ $student->id }}" @selected(old('id_siswa', $student->id) == $student->id)>
                ...
                <div class="mb-4 row align-items-center">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="form-control @error('mulai_tanggal') is-invalid @enderror"
                            id="mulai_tanggal" name="mulai_tanggal" value="{{ old('mulai_tanggal', $leave->mulai_tanggal->toDateString()) }}" />
                        @error('mulai_tanggal')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="mb-4 row align-items-center">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="form-control @error('sampai_tanggal') is-invalid @enderror"
                            id="sampai_tanggal" name="sampai_tanggal" value="{{ old('sampai_tanggal', $leave->sampai_tanggal->toDateString()) }}" />
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-8">
                        <textarea type="text" class="form-control @error('alasan') is-invalid @enderror" id="alasan" name="alasan" rows="3" placeholder="Apa alasan cutinya?">{{ old('alasan', $leave->alasan) }}</textarea>
                        @error('alasan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
